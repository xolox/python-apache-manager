"""
Documentation build configuration file for the `apache-manager` package.

This Python script contains the Sphinx configuration for building the
documentation of the `apache-manager` project. This file is execfile()d with
...
# Add the 'apache-manager' source distribution's root directory to the module path.
...
release = apache_manager_version
